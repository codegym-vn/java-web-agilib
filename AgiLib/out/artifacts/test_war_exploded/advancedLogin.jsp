...
<%
    ...
    if (login != null) {
        ...
        try{
            ...
            java.sql.PreparedStatement pst = conn.prepareStatement("Select username,password from user where username=? and password=?");
...
<body>
    ...
    <h1>ĐĂNG NHẬP</h1>
    <form name="register-frm" method="post" action="advancedLogin.jsp" >
    <table>
    <tr>
        <td>Tài khoản</td>
